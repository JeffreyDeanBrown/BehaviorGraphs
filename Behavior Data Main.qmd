...
spreadsheet_name <- c('example_sheets/Behavior Data 01-08-24.xlsx')

#setwd("/mnt/Windows_E/Syncthing/R_projects/Mouse Behavior/mouse_behavior_graphs")


data <- organize_data()  #Do not change the name of this 'data' tibble unless you also change Glue Functions.R
...
genotype_of_the_day <- "OSKO"
filename_of_the_day <- "PDFs/OSKO.pdf"
...
#       group_subtitle using the same syntax from plot_the_data
#
